...
module.exports = [
  ...
  {
    // logger.ts IS the structured-logging primitive — it is allowed to call
    // console directly. Benches print human-readable summaries.
    files: ['src/logger.ts', '**/*.bench.ts'],
    rules: {
      'no-console': 'off',
    },
  },
